component entityName="Staff" table="Staff" persistent=true extends="models.orm.Base" {
	// primary key
	...
	// many-to-one
	property name="Position" column="PositionID" fieldtype="many-to-one" cfc="models.orm.option.Position" fkcolumn="PositionID";
	// many-to-many
	property name="UserRoles" singularname="UserRole" fieldtype="many-to-many" cfc="models.orm.option.UserRole" linktable="StaffUserRole" fkcolumn="StaffID" inversejoincolumn="UserRoleID" lazy="extra";
