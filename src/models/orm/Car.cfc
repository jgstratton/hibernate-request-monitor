component entityName="Car" table="Car" persistent=true extends="models.orm.Base" {
	...
	// one-to-many
	property name="Images" singularname="Image" fieldtype="one-to-many" cfc="models.orm.Image" fkcolumn="CarID" inverse=true cascade="all-delete-orphan";
	// many-to-one
	property name="Status" column="StatusID" fieldtype="many-to-one" cfc="models.orm.option.Status" fkcolumn="StatusID" lazy="true";
	property name="Make" column="MakeID" fieldtype="many-to-one" cfc="models.orm.option.Make" fkcolumn="MakeID" lazy="true";
	property name="Model" column="ModelID" fieldtype="many-to-one" cfc="models.orm.option.Model" fkcolumn="ModelID" lazy="true";
	property name="Category" column="CategoryID" fieldtype="many-to-one" cfc="models.orm.option.Category" fkcolumn="CategoryID" lazy="true";
	property name="Color" column="ColorID" fieldtype="many-to-one" cfc="models.orm.option.Color" fkcolumn="ColorID" lazy="true";
	property name="DriveTrain" column="DriveTrainID" fieldtype="many-to-one" cfc="models.orm.option.DriveTrain" fkcolumn="DriveTrainID" lazy="true";
	// many-to-many
	property name="SalesPeople" singularname="SalesPerson" fieldtype="many-to-many" cfc="models.orm.Staff" linktable="CarStaff" fkcolumn="CarID" inversejoincolumn="StaffID" lazy="extra";
	property name="Features" singularname="Feature" fieldtype="many-to-many" cfc="models.orm.option.Feature" linktable="CarFeature" fkcolumn="CarID" inversejoincolumn="FeatureID" lazy="extra";
	property name="ActiveFeatures" singularname="ActiveFeature" fieldtype="many-to-many" cfc="models.orm.option.Feature" linktable="CarFeature" fkcolumn="CarID" inversejoincolumn="FeatureID" lazy="extra" where="Active=1";
